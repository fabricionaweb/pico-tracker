...
| Metric | Value | Status |
|--------|-------|--------|
| Total Requests | 1,870,049 | - |
| Successful | 1,870,049 (100.00%) | - |
| Failed | 0 (0.00%) | - |
| Requests/Second | 62,331.23 | Excellent |
...
|-----------|-------|-------------|-------------|----------------|
| Connect | 100 | 3.79ms | 4.49ms | 0.1-2ms |
| Announce | 1,558,318 | 1.61ms | 2.99ms | 0.5-5ms |
| Scrape | 311,631 | 1.59ms | 2.98ms | 0.2-3ms |
...
|-----------|-----|-----|-----|-----|-----|-----|
| Connect | 0.70ms | 3.79ms | 4.16ms | 4.49ms | 5.51ms | 5.51ms |
| Announce | 0.03ms | 1.61ms | 1.59ms | 2.99ms | 3.28ms | 8.12ms |
| Scrape | 0.03ms | 1.59ms | 1.59ms | 2.98ms | 3.28ms | 8.23ms |
...
| Medium Load | 100 | 30s | 62,331 | 2.99ms | Excellent |
